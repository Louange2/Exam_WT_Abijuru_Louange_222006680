...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <input type="text" id="mnt" name="mnt" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO orders(order_id, id, order_date, amount) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $oid, $uid, $odt, $mnt);
      ...
      include('database_connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $oid = $row['order_id']; // Fetch the order_id
                echo "<tr>
                    <td>" . $row['order_id'] . "</td>
                    <td>" . $row['id'] . "</td>
